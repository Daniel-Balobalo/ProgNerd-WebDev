...
In JavaScript, functions are a very important feature of the program, and especially 
the fact that they can access local variables of a parent function (this is called a closure).
...
In this function, the name argument to the greet function is used inside the function to 
construct a new string and return it using the return statement.
...
console.log(multiplyFive(3));   //prints: 15
console.log(multiplyFive(4));   //prints: 20
console.log(multiplyFive(5));   //prints: 25
console.log(multiplyFive(6));   //prints: 30